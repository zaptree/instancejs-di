...
_.extend(Di.prototype, {
	...
	get: function (key) {
		...
		if(singleton && injector.instanceCache[key]){
			return this.options.async ? Promise.resolve(injector.instanceCache[key]) : injector.instanceCache[key];
		}
		...
		if (this.options.async) {
			return Promise.resolve()
				...
				.then(function (factory) {
					...
					var module = _.isFunction(mod.$constructor) ? new (mod.$constructor.bind.apply(mod.$constructor, [mod.$constructor].concat(resolvedDependencies))) : mod.$constructor;
