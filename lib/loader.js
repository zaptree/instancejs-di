...
Loader.prototype.get = function(key, injector, standardRequire){
	...
	if(file){
		...
		if(!modules[file]){
			...
			var moduleString = 'global.$$tmpDiModGlobal = function (module, injector, include) {'+(fileBuffer.toString()) + '\n}';
		...
		var mockModule = {};
		modules[file](mockModule, injector, injector.include.bind(injector));
